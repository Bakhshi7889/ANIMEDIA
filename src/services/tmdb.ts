...
export const getImageUrl = (path: string | null, size: 'w92' | 'w185' | 'w300' | 'w500' | 'original' = 'w500') => {
  if (!path) return 'https://via.placeholder.com/500x750/111111/333333?text=No+Image';
